                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                                ...
                                children: <Widget>[
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                      children: <Widget>[
                                        Text('HEART', style: TextStyle(fontFamily: 'Montserrat Medium', color: Colors.teal, fontSize: 28)),
                                      ]
                                  )
                                ]
                            )
                              ...
                              Card(
                                ...
                                child: new InkWell(
                                  ...
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      Image.asset('assets/images/heart-beat.png', height: size.height*.1,),
                              ...
                              Card(
                                ...
                                child: new InkWell(
                                  ...
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      Image.asset('assets/images/information.png', height: size.height*.1,),
                              ...
                              Card(
                                ...
                                child: new InkWell(
                                  ...
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      Image.asset('assets/images/history.png', height: size.height*.1),
                              ...
                              Card(
                                ...
                                onTap: () {
                                  ...
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      Image.asset('assets/images/identity-card.png', height: size.height*.1),

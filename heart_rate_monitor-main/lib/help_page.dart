                            ...
                            Expanded(
                                child: SingleChildScrollView(
                                    ...
                                    child: Column(
                                        children: <Widget>[
                                          SizedBox(height: 20),
                                          Text('How to measure my heart rate?', style: TextStyle(fontSize: 20, fontFamily: 'Montserrat Medium',color: Colors.teal)),
                                          SizedBox(height: 10),
                                          ...
                                          SizedBox(height: 20),
                                          Text('WARNING', style: TextStyle(fontSize: 20, fontFamily: 'Montserrat Medium',color: Colors.teal)),
                                          SizedBox(height: 10),
                                          ...
                                          SizedBox(height: 20),
                                          Text('Tips', style: TextStyle(fontSize: 20, fontFamily: 'Montserrat Medium',color: Colors.teal)),
                                          SizedBox(height: 10),
